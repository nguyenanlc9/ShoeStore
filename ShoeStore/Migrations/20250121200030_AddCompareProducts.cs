...
{
    /// <inheritdoc />
    public partial class AddCompareProducts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CompareProductId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompareProducts", x => x.CompareProductId);
                    table.ForeignKey(
